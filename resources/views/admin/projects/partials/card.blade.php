...
<div class="pm-card text-black  ">
        ...
        <h6 class="mt-4 text-dark">Project Manager: {{$project->project_manager}}</h6>
        <div class="">
            <h6 class="mt-4 text-dark d-inline">Git Repo: </h6>
            <a target="_blank" href="{{$project->repository}}"> Link</a>
        </div>
